...
- Member of the **RankEmbed** team, owning the system for vector embedding-based retrieval for Search.
- Engineered and deployed a plan to decouple RankEmbed's backend routing from binary rollouts using Google's internal datapush tools.
    - Enabled real-time updates to routing, significantly improving system agility and reducing reaction time for outages from **8hrs to 15 mins**.
    - Integrated RankEmbed with Google's experiment impact and cost control framework.
- Established automated checks to block experimental features that cause unsanctioned costs or break RankEmbed, safeguarding production stability.
    - Blocked 9 potential production-breaking experiments as of now.
*   **Automated RankEmbed's eval backend refreshes** : Designed agentic solution to reduce human toil from **2 SWE days** to **4 hours**, minimising chance of human error.
...
- Reduced scale-up time from 15 mins to 2 mins and enabled infinite scaling.
- Delivered end-to-end features: made peripheral services for managing serverless jobs, including a scheduler, sentinel, and validator.
...
**Electives:** Data Storage Technology and Networks, Computer Networks, Operating Systems, Database Systems.

## Technical Proficiency

C++, Android Development, Python, C Programming, Sensors, Git, Microcontrollers.
...
Winner of the 24-hour national hackathon featuring 79 shortlisted teams
